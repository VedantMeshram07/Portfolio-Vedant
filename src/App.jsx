 ...
 *  Hero → Lore → Quests scroll journey — no separate components,
 *  no handoff complexity, no z-index fighting.
 * ─────────────────────────────────────────────────────────────────────
 */
export default function App() {
  ...
  useEffect(() => {
    ...
    window.__lenis = lenis; // DEBUG: expose for testing
